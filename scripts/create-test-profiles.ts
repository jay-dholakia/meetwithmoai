...
// Run with: npx ts-node scripts/create-test-profiles.ts
...
async function createProfile(profileData: any) {
  ...
  const responses = Object.entries(profileData.responses).map(([question_id, answer]) => ({
    ...
    answer,
    type: question_id.startsWith('q') && ['q5', 'q6', 'q14', 'q15', 'q16', 'q17', 'q18', 'q19', 'q21', 'q22', 'q23'].includes(question_id) ? 'structured' : 'open_ended',
...
function getQuestionText(questionId: string): string {
  // Simplified - in real app this would come from the questions array
